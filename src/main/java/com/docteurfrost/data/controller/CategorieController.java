...
public class CategorieController {
	...
	@GetMapping()
	@ResponseBody
	public List<CategorieDTO> findAllCategoriesDTO( ) {
	...
	@ResponseBody
	public CategorieDTO findCategorieDTO( @PathVariable("nomCategorie") String nomCategorie ) {	
		return new CategorieDTO( categorieService.findCategorie(nomCategorie) ) ;	
	}
	
	@PostMapping()
	@ResponseBody
	public ResponseEntity<String> createCategoryDTO(@RequestBody CategorieDTO categorieDTO) {
		
		categorieService.createCategoryDTO(categorieDTO);
