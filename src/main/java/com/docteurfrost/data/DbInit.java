...
public class DbInit {
    ...
    private void postConstruct() {
        ...
        Article article = new Article("TV1", "Tv ecran un peu fissuree en haut a droite", categorie, conteneur, marque, 50000, 0, 0, 100000, null, false, null );
        article.decharger();
        article.deballer();
        articleRepository.save(article);
        
        Article article2 = new Article("TV2", "Tv propre 100 neuve", categorie, conteneur, marque, 80000, 0, 0, 200000, null, true, null );
        articleRepository.save(article2);
        
        Article article3 = new Article("TV3", "Tv", categorie, conteneur, marque, 42000, 0, 0, 70000, null, false, null );
        articleRepository.save(article3);
        
        Article article4 = new Article("Tel1", "Telephone neuf", categorie2, conteneur, marque, 35000, 0, 0, 70000, null, false, null );
        articleRepository.save(article4);
        
        OptionCategorie option = new OptionCategorie(categorie, "Telecommande", "La tele a elle une telecommande ?", false);
        ...
        OptionCategorie option2 = new OptionCategorie(categorie, "Satelitte", "Est-ce une TV Satelitte ?", false);
        ...
        OptionCategorie option3 = new OptionCategorie(categorie, "Pieds", "La tele a elle ses pieds ?", false);
        ...
        OptionCategorie option4 = new OptionCategorie(categorie, "Couleur", "Couleur ?", false);
